...
HD_PWD='/home/madsr2d2/DTU/dds/dds_as2/dds_as2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acc.tcl
