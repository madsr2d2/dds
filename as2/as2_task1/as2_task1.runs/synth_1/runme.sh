...
HD_PWD='/home/madsr2d2/DTU/dds/as2/as2_task1/as2_task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_buffer_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_buffer_1.tcl
