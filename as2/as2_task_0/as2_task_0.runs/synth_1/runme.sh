...
HD_PWD='/home/madsr2d2/DTU/dds/as2/as2_task_0/as2_task_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory2.tcl
