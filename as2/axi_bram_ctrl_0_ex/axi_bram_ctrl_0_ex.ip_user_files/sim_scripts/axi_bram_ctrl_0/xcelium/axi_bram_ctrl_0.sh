...
design_libs_elab="-libname xpm -libname axi_bram_ctrl_v4_1_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_bram_ctrl_v4_1_10 xil_defaultlib)
