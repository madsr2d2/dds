...
#
# Script generated by Vivado on Tue Oct 22 23:29:02 CEST 2024
...
# script info
echo -e "axi_bram_ctrl_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_bram_ctrl_v4_1_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_0 xil_defaultlib.axi_bram_ctrl_0 xil_defaultlib.glbl -log elaborate.log
}
