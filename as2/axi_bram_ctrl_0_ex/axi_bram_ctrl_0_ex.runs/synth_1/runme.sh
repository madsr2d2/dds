...
HD_PWD='/home/madsr2d2/DTU/dds/as2/axi_bram_ctrl_0_ex/axi_bram_ctrl_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_bram_ctrl_0_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_bram_ctrl_0_synth.tcl
