...
HD_PWD='/home/madsr2d2/DTU/dds/as1/task_4/task_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_module.tcl
